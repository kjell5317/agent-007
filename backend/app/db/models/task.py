...
class Task(Base):
    ...
    # Agent's judgement of whether an AI assistant could meaningfully do
    # this task: "yes" / "no" / "unsure". Nullable for legacy rows.
    ai_doable: Mapped[str | None] = mapped_column(String(8), nullable=True)
